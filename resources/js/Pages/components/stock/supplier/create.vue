        ...
        <template #default>
            ...
            >
                ...
                <div class="flex-auto px-4 lg:px-10 py-10 pt-0">
                    <form class="mt-4" @submit.prevent="supplierInsert" enctype="multipart/form-data">
                        ...
                        <div class="flex justify-center">
                            <button
                                class="bg-green-500 text-white active:bg-green-600 font-bold uppercase text-xs px-6 py-2 rounded
