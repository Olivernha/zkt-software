                    ...
                    >
                        ...
                        <div class="block w-full overflow-x-auto">
                            ...
                            <table class="items-center w-full bg-transparent border-collapse">
                                ...
                                <tr>
                                    <th
                                        class="px-2 bg-gray-100 text-center text-gray-600 align-middle border border-solid border-gray-200 py-3 text-xs uppercase border-l-0 border-r-0 whitespace-no-wrap font-semibold text-left"
                                    >
                                        Name
                                    </th>
                                    <th
                                ...
                                <tr  v-for="item in cart" :key="item.id">
                                    <th
                                        class="border-t-0 text-center  px-2 align-middle border-l-0 border-r-0 text-xs whitespace-no-wrap p-4 text-left"
                                    >
                                        {{ item.name }}
                                    </th>
                                    <td
                                        class="border-t-0 text-center  px-2 align-middle border-l-0 border-r-0 text-xs whitespace-no-wrap p-4"
                                    >
                                        {{ item.quantity }}
                                    </td>
                                    <td
                                    ...
                                    >
                                        <button @click="increaseQuantity(item.id)" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-2 rounded">
                                           +
                                        </button>
                            ...
                            <div class="container mx-auto px-4">
                                <div class="flex flex-wrap my-2">
                                    <div
                                        class="relative flex flex-col min-w-0 break-words border border-2 bg-white w-full shadow-lg rounded-lg"
                                    >
                                    ...
                                    <form @submit.prevent="order">
                                        ...
                                        <div class="relative w-full mb-3">
                                            ...
                                            <select v-model="customer"
                                                class="block appearance-none text-gray-600 w-full bg-white border border-gray-400 hover:border-gray-500 px-4 py-2 pr-8 rounded shadow leading-tight focus:outline-none focus:shadow-outline"
                                            >
                                                <option :value="c.id" v-for="c in $page.props.customers" :key="c.id">{{ c.name }}</option>
                                            </select>
                                        </div>
                                        <div class="relative w-full mb-3">
                                            <label
                        ...
                        <div class="rounded-t mb-0 px-4 py-3 border-0">
                            ...
                            <div>
                                <nav class="flex flex-col sm:flex-row flex-wrap">
                                    <button @click="reset"
                                            :class="{ 'border-b-2 text-blue-500  border-blue-500' : condition === '' }"
                                    ...
                                    <button
                                        ...
                                        :class="{'border-b-2 text-blue-500 border-blue-500' : condition === category.id }"
                                        class="text-gray-600 py-4 px-6 block hover:text-blue-500 focus:outline-none   font-medium
                            ...
                            >
                                <button @click.prevent="AddToCart(product)">
                                    ...
                                    <div class="text-center my-2">
                                        ...
                                        <p class="my-2">{{ product.quantity < 1 ? "Stock Out" : "Available" }}</p>
                                    </div>
                                </button>
    ...
    computed:{
        ...
        filterProduct(){
            return this.products.filter(data=>{
                return data.product_name.toLowerCase().includes(this.searchList.toLowerCase());
            })
        },
        cart(){
